...
\section*{Publications} \rightline{\textbf{(* = co-first author; $\dagger$ = corresponding author; \underline{student co-author})}}
 ...
 & \textbf{Popov, V.} \& Oberauer, K. (submitted). How to build an observatory for the mind. Preprint available at https://doi.org/10.31234/osf.io/hmu9r\\[6pt]
&\\
& van Dongen, N. N., Glöckner, A., Musfeld, P., Sarafoglou, A., Borsboom, D., … \textbf{Popov, V.}, … Yuan, L. (submitted). The state and status of theory in psychological science. Preprint available at https://doi.org/10.31234/osf.io/2fjx4\\[6pt]
&\\
& \underline{Barthelmes, B. T.} \& \textbf{Popov, V.} (submitted). Towards measuring the theory crisis in psychology: An LLM-assisted discourse-analysis approach. Preprint available at https://doi.org/10.31234/osf.io/4y2sp\\[6pt]
&\\
& Greeno, D. J., Morey, C. C., \& \textbf{Popov, V.} (submitted). Encoding serial items depletes cognitive resource: An adversarial comparison of reconfiguration and resource-depletion accounts of working memory. Preprint available at https://doi.org/10.31234/osf.io/vj8pn\\[6pt]
&\\
...
&\\
& \textbf{Popov, V.} (under revision). If God Handed Us the Ground-Truth Theory of Memory, How Would We Recognize It? Preprint available at https://psyarxiv.com/ay5cm/\\
 \end{longtable}

\subsection*{Journal publications}

\begin{longtable}{p{0.7cm}p{15cm}}
2026 & Ma, S., \textbf{Popov, V.}, \& Zhang, Q. (2026). Cognitive constraints and reward environments jointly shape memory formation. {\it Psychological Review.} Advance online publication. https://doi.org/10.1037/rev0000612\\[6pt]
&\\
...
\begin{longtable}{p{0.7cm}p{15cm}}
2024 & \textbf{Popov, V.} \& Reder, L. (2024). Frequency effects in recognition and recall. In M. Kahana \& A. Wagner (Eds.), {\it The Oxford Handbook of Human Memory} (pp. 765--796). Oxford University Press. https://doi.org/10.1093/oxfordhb/9780190917982.013.27
\end{longtable}
