...
description: "I use renv for package management and Quarto for publishing. I freeze posts so they don’t get recomputed every time. I hadn’t touched the blog in a few months. I just wanted to fix a couple of typos. Two minutes of work. Run `quarto render`. Done. Except, of course, not done."
...
At this point I start wondering whether this has something to do with Quarto. [Some posts](https://github.com/venpopov/venpopov.github.io/blob/main/posts/2025/arto-pollo/index.qmd) use post-specific packages declared via `renv::use("packagename@version")`, [as recommended in the documentation](https://rstudio.github.io/renv/articles/use.html). Maybe those dependencies don’t fully participate in the main restore/snapshot logic? Maybe I’ve built myself a beautiful little Rube Goldberg machine of reproducibility.
