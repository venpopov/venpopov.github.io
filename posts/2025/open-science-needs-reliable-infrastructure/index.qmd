...
Despite this response, I was still deeply troubled. I briefly considered whether I'm overreacting. However, after consulting several colleagues, they were all also very concerned not only that this had happened, *but that it was possible to happen in the first place*. As one of my colleagues put it:

> I agree, I think the issue is more severe than it sounds like. The effect is crazy to me. Not only that they retrospectively delete the stuff but also how many people can be affected by it. It’s already severe in your case with a large network of collaborators. Butimagine Klaus's account gets flagged and he doesn’t realize it. This would probably take hundreds of preprints offline, which are primary the work of others [junior researchers]. It’s bad enough that they take the stuff down that you put on OSF but it also deletes the work where someone else just linked your name with? This also can’t be right...
...
That, to me, felt like the right place to stop. That said, ideally, I would like some official statement from COS about what they plan to do in order to ensure that something like this doesn't happen again in the future.
